    ...
    return (
        <div className="text-start" style={{ padding: '20px 60px 4px 30px', width: "100%" }}>
            ...
            <div className='button-group'>
                <span >{"Verify With Disclosures" + getTrailingWhiteSpace(2)} <UploadFileIcon color='info' /></span>
                <span>{"Download Report" + getTrailingWhiteSpace(4)}<CloudDownloadIcon color='info' /></span>
            </div>
        </div>
    )
}
