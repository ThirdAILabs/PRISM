        ...
        <div className="text-start card-container" style={{ width: '100%' }}>
            <div className="card-top" style={{ padding: '20px 20px 4px 30px', flexGrow: 1 }}>
                ...
                <div className="info-row" style={{ marginTop: '10px' }}>
                    ...
                    <span className="content">
                        {result.Institutions && result.Institutions[0] !== "" ? (
                            ...
                            <span className="content-research-placeholder">No institute information available</span>
                        )}
                    </span>
                </div>
                ...
                {result.Interests && result.Interests[0] !== "" ? (
                    ...
                    <div className="info-row">
                        <img src={Research} alt="Research" className="icon" />
                        <span className="content content-research-placeholder">No research interests available</span>
                    </div>
                )}
            </div>
            <Divider
            ...
            />
            <div className="card-footer" style={{ height: '40px', display: 'flex', alignItems: 'center' }}>
                <div className="button-group" style={{ width: '100%', height: '36px' }}>
                    <span onClick={verifyWithDisclosure.handleFileUploadClick}>
                        {'Verify With Disclosures' + getTrailingWhiteSpace(2)} <UploadFileIcon color={loading ? "disabled" : "info"} />
                        <input
                            type="file"
                    ...
                    <span onClick={() => { if (!loading) setDownloadDropdownOpen(!downloadDropdownOpen) }} ref={dropdownDownloadRef}>
