...
const AdminPage = () => {
  ...
  const isShowUserCard = (status) => {
    ...
    if (status && selectedUserTab === 'Active') return true;
    if (!status && selectedUserTab === 'Inactive') return true;
    return false;
  };
  ...
  useEffect(() => {
    ...
    setUsers(
      initialUsers.filter((user) => {
        if (user.username.toLocaleLowerCase().includes(searchTerm.toLocaleLowerCase())) return true;
        return false;
      })
    );
    ...
    <div className="user-container">
        ...
        <div className="admin-card-content">
          ...
          >
            ...
            <div className="admin-card-content__info">
              <span className="admin-card-content__name">
                {users[0]?.username}
                <span className={`admin-card-content__status`}>Admin</span>
              </span>
              <span className="admin-card-content__email">{users[0]?.email}</span>
            </div>
          </div>
          <button className="button button-3d generate-key-button">
        ...
        <div className="stats">
          <div className="stats-card-1">
            ...
            >
              ...
              <div className="stats__info">
                <span className="stats__name">{'Total Searches'}</span>
          ...
          <div className="stats-card-2">
            ...
            >
              ...
              <div className="stats__info">
                <span className="stats__name">{'Plan Search Left'}</span>
          ...
          <div className="stats-card-3">
            ...
            >
              ...
              <div className="stats__info">
                <span className="stats__name">{'Total Searches Left'}</span>
        ...
        <div className="stats">
          <div className="stats-card-1">
            ...
            >
              ...
              <div className="stats__info">
                <span className="stats__name">{'Total Cost'}</span>
                <span className="stats__email">{'30,000'}</span>
              </div>
            </div>
          </div>
          <div className="stats-card-2">
            ...
            >
              ...
              <div className="stats__info">
                <span className="stats__name">{'Input Token'}</span>
                <span className="stats__email">{'14,000'}</span>
              </div>
            </div>
          </div>
          <div className="stats-card-3">
            ...
            >
              ...
              <div className="stats__info">
                <span className="stats__name">{'Output Token'}</span>
                <span className="stats__email">{'18,000'}</span>
              </div>
            </div>
          </div>
      ...
      <div className="user-header">
        <div className="user-header-tab">
          <span
            className={`user-header-tabs ${selectedUserTab === 'All' ? 'active' : ''}`}
            onClick={() => {
              handleTabClick('All');
            }}
          >
          ...
          <span
            className={`user-header-tabs ${selectedUserTab === 'Active' ? 'active' : ''}`}
            onClick={() => {
          ...
          <span
            className={`user-header-tabs ${selectedUserTab === 'Inactive' ? 'active' : ''}`}
            onClick={() => {
      ...
      <div className="user-list">
        {users.map((user, index) => {
          return (
            isShowUserCard(user.state) && (
              <div className="users-card">
                <img src={user.avatar} alt="User" className="users-card__avatar" />
                <div className="users-card__info">
                  <span className="users-card__name">
                    {user.username}
                    <span
                      className={`users-card__status ${!user.state ? 'users-card__status--inactive' : ''}`}
                    >
