...
KEYCLOAK_ADMIN_URL="http://localhost:8180/realms/prism-admin/protocol/openid-connect/token"
KEYCLOAK_USER_URL="http://localhost:8180/realms/prism-user/protocol/openid-connect/token"

LICENSE_URL="http://localhost:8082/api/v1/license/create"
ACTIVATE_LICENSE_URL="http://localhost:8082/api/v1/report/activate-license"
...
USER_USERNAME="sineanand" # To Change
