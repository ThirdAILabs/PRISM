...
func TestProcessorAcknowledgements(t *testing.T) {
	...
	t.Run("Case1", func(t *testing.T) {
		...
		1. 2025/03/10 21:13:10 WARN error retreiving acknowledgments for work report_id=16fbccd9-965c-481f-b28a-a3552dbef834 flagger=AcknowledgementEOC batch=0 error="error extracting acknowledgments for work https://openalex.org/W2016548646 (https://europepmc.org/articles/pmc3785380?pdf=render): unable to download pdf, http error: error downloading pdf from https://europepmc.org/articles/pmc3785380?pdf=render: Get \"https://europepmc.org/backend/ptpmcrender.fcgi?accid=PMC3785380&blobtype=pdf\": context deadline exceeded (Client.Timeout exceeded while awaiting headers), playwright error: error downloading pdf 'https://europepmc.org/articles/pmc3785380?pdf=render': timeout:Timeout 15000.00ms exceeded."
		2. 2025/03/10 21:19:32 WARN error retreiving acknowledgments for work report_id=ff3b3a0e-befa-4e90-9ad4-ba373104aeb6 flagger=AcknowledgementEOC batch=0 error="error extracting acknowledgments for work https://openalex.org/W1894293294 (https://europepmc.org/articles/pmc3623691?pdf=render): unable to download pdf, http error: error downloading pdf from https://europepmc.org/articles/pmc3623691?pdf=render: Get \"https://europepmc.org/articles/pmc3623691?pdf=render\": context deadline exceeded (Client.Timeout exceeded while awaiting headers), playwright error: error downloading pdf 'https://europepmc.org/articles/pmc3623691?pdf=render': timeout:Timeout 15000.00ms exceeded."
		2. 2025/03/10 21:19:31 WARN error retreiving acknowledgments for work report_id=ff3b3a0e-befa-4e90-9ad4-ba373104aeb6 flagger=AcknowledgementEOC batch=0 error="error extracting acknowledgments for work https://openalex.org/W2100877063 (https://europepmc.org/articles/pmc3572243?pdf=render): unable to download pdf, http error: error downloading pdf from https://europepmc.org/articles/pmc3572243?pdf=render: Get \"https://europepmc.org/articles/pmc3572243?pdf=render\": context deadline exceeded (Client.Timeout exceeded while awaiting headers), playwright error: error downloading pdf 'https://europepmc.org/articles/pmc3572243?pdf=render': timeout:Timeout 15000.00ms exceeded."
		3. 2025/03/10 21:24:17 WARN error retreiving acknowledgments for work report_id=edf72647-bbad-4a96-96f1-baef74cf233c flagger=AcknowledgementEOC batch=0 error="error extracting acknowledgments for work https://openalex.org/W1977046933 (https://europepmc.org/articles/pmc3781175?pdf=render): unable to download pdf, http error: error downloading pdf from https://europepmc.org/articles/pmc3781175?pdf=render: Get \"https://europepmc.org/backend/ptpmcrender.fcgi?accid=PMC3781175&blobtype=pdf\": context deadline exceeded (Client.Timeout exceeded while awaiting headers), playwright error: error downloading pdf 'https://europepmc.org/articles/pmc3781175?pdf=render': timeout:Timeout 15000.00ms exceeded."
		3. 2025/03/10 21:25:07 WARN error retreiving acknowledgments for work report_id=edf72647-bbad-4a96-96f1-baef74cf233c flagger=AcknowledgementEOC batch=0 error="error extracting acknowledgments for work https://openalex.org/W1894293294 (https://europepmc.org/articles/pmc3623691?pdf=render): unable to download pdf, http error: error downloading pdf from https://europepmc.org/articles/pmc3623691?pdf=render: Get \"https://europepmc.org/backend/ptpmcrender.fcgi?accid=PMC3623691&blobtype=pdf\": context deadline exceeded (Client.Timeout exceeded while awaiting headers), playwright error: error downloading pdf 'https://europepmc.org/articles/pmc3623691?pdf=render': timeout:Timeout 15000.00ms exceeded."
		4. 2025/03/10 21:34:46 WARN error retreiving acknowledgments for work report_id=a99934e9-6a66-4131-902c-0285b624b4d7 flagger=AcknowledgementEOC batch=0 error="error extracting acknowledgments for work https://openalex.org/W2016548646 (https://europepmc.org/articles/pmc3785380?pdf=render): unable to download pdf, http error: error downloading pdf from https://europepmc.org/articles/pmc3785380?pdf=render: Get \"https://europepmc.org/backend/ptpmcrender.fcgi?accid=PMC3785380&blobtype=pdf\": context deadline exceeded (Client.Timeout exceeded while awaiting headers), playwright error: error downloading pdf 'https://europepmc.org/articles/pmc3785380?pdf=render': timeout:Timeout 15000.00ms exceeded."
		6. 2025/03/10 21:51:30 WARN error retreiving acknowledgments for work report_id=b9e140a7-647a-4c91-b52c-7b2863a9bc6d flagger=AcknowledgementEOC batch=0 error="error extracting acknowledgments for work https://openalex.org/W2016548646 (https://europepmc.org/articles/pmc3785380?pdf=render): unable to download pdf, http error: error downloading pdf from https://europepmc.org/articles/pmc3785380?pdf=render: Get \"https://europepmc.org/backend/ptpmcrender.fcgi?accid=PMC3785380&blobtype=pdf\": context deadline exceeded (Client.Timeout exceeded while awaiting headers), playwright error: error downloading pdf 'https://europepmc.org/articles/pmc3785380?pdf=render': timeout:Timeout 15000.00ms exceeded."
		7. 2025/03/10 22:00:55 WARN error retreiving acknowledgments for work report_id=27bd23f2-0d51-44ea-91d7-0ea95cdf1440 flagger=AcknowledgementEOC batch=0 error="error extracting acknowledgments for work https://openalex.org/W2100877063 (https://europepmc.org/articles/pmc3572243?pdf=render): unable to download pdf, http error: error downloading pdf from https://europepmc.org/articles/pmc3572243?pdf=render: Get \"https://europepmc.org/articles/pmc3572243?pdf=render\": context deadline exceeded (Client.Timeout exceeded while awaiting headers), playwright error: error downloading pdf 'https://europepmc.org/articles/pmc3572243?pdf=render': timeout:Timeout 15000.00ms exceeded."
